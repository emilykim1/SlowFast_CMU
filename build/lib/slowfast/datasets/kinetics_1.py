...
#            )
            ...
            ####### Done ########
            data_dir = self._path_to_videos[index]
            all_frames = glob.glob(data_dir + '*.png')
            total_num = len(all_frames) - 65
            print(data_dir)
            all_frames = sorted(all_frames)
            random_index = rand.randint(0, total_num)
            for a in range(random_index, random_index + 65):
                frame = Image.open(all_frames[a])
