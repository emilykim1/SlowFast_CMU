    ...
    def _construct_loader(self):
        ...
        with pathmgr.open(path_to_file, "r") as f:
            for clip_idx, path_label in enumerate(f.read().splitlines()):
                ...
                path, label_0, label_1, label_2, label_3, label_4, label_5, label_6, label_7 = path_label.split(
                ...
                for idx in range(self._num_clips):
                    ...
                    self._labels.append(torch.tensor([int(label_0), int(label_1), int(label_2), int(label_3), int(label_4), int(label_5), int(label_6), int(label_7)]))
